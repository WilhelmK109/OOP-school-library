...
```sh
  cd my-folder
  git clone git@github.com:WilhelmK109/OOP-school-library.git
```
...
This project is [MIT](https://github.com/WilhelmK109/OOP-school-library/blob/dev/LICENSE) licensed.
